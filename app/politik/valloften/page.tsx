    ...
    <main className="guide-page" id="page-content" tabIndex={-1}>
      <article>
        ...
        <SectionNavigation
          ...
          items={[
            { href: '/valet-2026', label: 'Valfrågor' },
            { href: '/politik/valloften', label: 'Vallöften', current: true },
        ...
        <section className="promise-guide-list" aria-labelledby="promise-list-heading">
          ...
          <div>
            {promises.map((promise, index) => (
              <article key={promise.title} id={`vallofte-${index + 1}`}>
        ...
        <section className="promise-benchmark">
          <div><span>Historiskt exempel · valmanifest 2010</span><strong>78 %</strong><p>218 av 279 löften i Alliansens gemensamma valmanifest 2010 bedömdes helt uppfyllda.</p></div>
          <p>Det är en forskningsjämförelse, inte ett aktuellt regeringsbetyg. En ny total procentsats kräver ett komplett urval med urvalsregler fastställda i förväg.</p>
